...
import Fox.core.lib.service.acousticid.AcousticIDClient;
...
public class testingJson {
    public static void main(String[] args) {
        ...
        AcousticIDRequestConfig config = new AcousticIDRequestConfig();

        config.setRecordings();
        config.setReleasegroups();

        AcousticIDClient client = new AcousticIDClient(config);
