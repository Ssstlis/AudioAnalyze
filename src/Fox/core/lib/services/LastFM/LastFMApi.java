...
public class LastFMApi
{
    ...
    public final LastFMTrackClient Track = new LastFMTrackClient();
    public final LastFMArtistClient Artist = new LastFMArtistClient();
    public final LastFMAlbumClient Album = new LastFMAlbumClient();
}
