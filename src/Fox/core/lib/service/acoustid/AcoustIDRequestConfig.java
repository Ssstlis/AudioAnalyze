...
public class AcoustIDRequestConfig
{
    ...
    public void setDefault() {
        ConfigMap.put("recordings", true);
        ConfigMap.put("releasegroups", true);
        ConfigMap.put("recordingids", false);
        ConfigMap.put("releasegroupids", false);
        ConfigMap.put("releaseids", false);
        ConfigMap.put("releases", false);
        ConfigMap.put("tracks", false);
        ConfigMap.put("usermeta", false);
        ConfigMap.put("sources", false);
        ConfigMap.put("compress", false);
    }

    public void setAll()
    {
        setMax();
        ConfigMap.put("recordingids", true);
        ConfigMap.put("releasegroupids", true);
        ConfigMap.put("releaseids", true);
        ConfigMap.put("compress", true);
    }
    ...
    public void setMax()
    {
        ConfigMap.put("recordings", true);
        ConfigMap.put("releasegroups", true);
        ConfigMap.put("releases", true);
        ConfigMap.put("tracks", true);
        ConfigMap.put("usermeta", true);
        ConfigMap.put("sources", true);
    }

    public void unsetAll()
    {
        ConfigMap.put("recordings", false);
        ConfigMap.put("releasegroups", false);
        ConfigMap.put("recordingids", false);
        ConfigMap.put("releasegroupids", false);
        ConfigMap.put("releaseids", false);
        ConfigMap.put("releases", false);
